...
def main():
    ...
    output_base_folder = "./benchmark_results_rnd_ccdc"
    ...
    for run in range(1, num_runs + 1):  
        ...
        benchmark = MolScoreBenchmark(benchmark='3D_Benchmark', model_name='randomSampler', output_dir=output_dir, budget=1000, )
    ...
    average_scores.to_csv(os.path.join(output_base_folder, "average_results_rnd_ccdc.csv"), index=False)
